...
class Personagem {
    ...
    public static function novo(int $id_usuario, string $nome, int $idade, string $raca, int $nivel, int $agilidade, int $forca, int $intelecto, int $constituicao, int $carisma, int $magia, string $aparencia): Personagem {
        if ($id_usuario <= 0) {
    ...
    public function alterarDados(string $nome, int $idade, string $raca, int $nivel, int $agilidade, int $forca, int $intelecto, int $constituicao, int $carisma, int $magia, string $aparencia): void {
        $nome = trim($nome);
        $raca = trim($raca);
