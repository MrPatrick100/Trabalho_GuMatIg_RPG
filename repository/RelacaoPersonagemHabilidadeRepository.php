...
class RelacaoPersonagemHabilidadeRepository {
    ...
    public function salvar(RelacaoPersonagemHabilidade $relacao): void {
        ...
        $stmt = $this->pdo->prepare(
            'INSERT INTO personagem_habilidade (id_personagem, id_habilidade) VALUES (:id_personagem, :id_habilidade)'
        );
        $stmt->execute([
    ...
    public function inserir(int $id_personagem, int $id_habilidade): void {
        $relacao = RelacaoPersonagemHabilidade::novo($id_personagem, $id_habilidade);
        $this->salvar($relacao);
    }
